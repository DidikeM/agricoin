...
uint256 hashGenesisBlock("0xf2a40fecd71a1affd4b58b3c9d47b62e3df2b0874f31c1f8fd4ec96fe379985e");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 420000); // Agricoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Agricoin: 3 days
static const int64 nTargetSpacing = 2 * 60; // Agricoin: 2 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe4fd0e67350e289c891ea82850046027f5dffc3cefcc6105330b9cda22035eb7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "27/12/2023 Emir sanırım staj buldu biz hala bulamadık.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 25 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("049ff93cbd009a2d153e1cef88f771d6542769c65958cd57d5f6cc8e21a072ad3d3c01c5c77ccf49671aa4412df0f22d8cc41c0fba0b6e335d1dde45d0e47c99e8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1703682467;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084773186;

        if (fTestNet)
        {
            block.nTime    = 1703682427;
            block.nNonce   = 386076840;
        }
	if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x668aae609f4af3a1b448c1e06346e90ebc6c4a61fecce02d2b30fb43909fdc48"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x2c, 0x25, 0x0c, 0x5c }; // Agricoin: increase each by adding 2 to bitcoin's value.
